...
public class SmsController implements Initializable {
    ...
    @FXML
    private TableColumn<Sms, String> emetteurcolumn;
    ...
    public void handleEnregistrer() {
        ...
        if (Connexion.peutLire(Sms.class) || Connexion.peutModifier(Sms.class)) {
            try {
                ...
                String resultat;
                if (smsSelectionne == null)
                    resultat = smsFacade.enregistrer("","",destinaireSms, emetteurSms, contenuSms);
                else
                    resultat = smsFacade.modifier(smsSelectionne, "", "", destinaireSms, emetteurSms, contenuSms);
