...
public class NiveauController implements Initializable {
    ...
    public void handleEnregistrer() {
        ...
        if (Connexion.peutLire(Niveau.class) || Connexion.peutModifier(Niveau.class)) {
            try {
                String numeroNiveau, descriptionNiveau;
                ...
                String resultat;
                if (niveauSelectionne == null)
                    resultat = niveauFacade.enregistrer("",descriptionNiveau,Integer.parseInt(numeroNiveau));
                else
                    resultat = niveauFacade.modifier(niveauSelectionne, "", descriptionNiveau, Integer.parseInt(numeroNiveau));
