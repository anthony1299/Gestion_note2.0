        ...
        if (Connexion.peutLire(Discipline.class) || Connexion.peutModifier(Discipline.class)) {
            try {
               ...
               absenceDiscipline  = absence.getText();
                ...
                String resultat;
                if (disciplineSelectionne == null)
                    resultat = disciplineFacade.enregistrer(libelleDiscipline, descriptionDiscipline, Integer.parseInt(absenceDiscipline), Integer.parseInt(retardDiscipline), etudiantclasse, semestreclasse);
                else
                    resultat = disciplineFacade.modifier(disciplineSelectionne, libelleDiscipline, descriptionDiscipline, Integer.parseInt(absenceDiscipline), Integer.parseInt(retardDiscipline), etudiantclasse, semestreclasse);
