...
public class UtilisateurController implements Initializable {
    ...
    public void handleEnregistrer() {
        ...
        if (Connexion.peutLire(Utilisateur.class) || Connexion.peutModifier(Utilisateur.class)) {
            try {
                String nomutilisateur, prenomutilisateur, emailutilisateur, telephoneutilisateur, loginutilisateur, mdputi;
                ...
                String resultat;
                if (utilisateurSelectionne == null)
                    resultat = utilisateurFacade.enregistrer("","",nomutilisateur,prenomutilisateur,emailutilisateur,Integer.parseInt(telephoneutilisateur),dateNaissanceutilisateur,sexe, Personne.Statut.ACTIVE, loginutilisateur, "");
                else
                    resultat = utilisateurFacade.modifier(utilisateurSelectionne,"","",nomutilisateur,prenomutilisateur,emailutilisateur,Integer.parseInt(telephoneutilisateur),dateNaissanceutilisateur,sexe, Personne.Statut.ACTIVE, loginutilisateur, "");
