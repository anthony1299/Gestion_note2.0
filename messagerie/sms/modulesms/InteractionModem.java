...
public class InteractionModem extends OutboundMessage {
    ...
    public InteractionModem() {
        ...
        this.fréquence = 9600;
        this.NumeroTelephonePuce = "656307859"; //656315924
        this.marqueModem = "HUAWEI";
        this.gateway = new SerialModemGateway(this.nomModem, this.port, this.fréquence, this.marqueModem, this.versionModemUtiliser);
